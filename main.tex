...
\begin{equation}
    V_{i} C_{i, \text{micro}}\left(p^{b}\right) \frac{p_{i}^{t+\Delta t}-p_i^{t}}{\Delta t}+\sum_{j=1}^{N_{i}} T_{i j, \text{micro}}\left(p^{b}\right)\left(p_{j}^{t+\Delta t}-p_{i}^{t+\Delta t}\right)=0
\end{equation}
